...
# Configuration
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'prothemesru-super-secret-2024')
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///prothemesru.db')
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['JWT_SECRET_KEY'] = os.environ.get('JWT_SECRET_KEY', 'prothemesru-jwt-secret-2024')
    ...
    if not Template.query.first():
        templates = [
            Template(
                ...
                downloads=150,
                rating=4.5,
                description='Профессиональный сайт для бизнеса',
                preview_url='/templates/business.jpg'
            ),
            Template(
                name='Портфолио',
                category='portfolio',
            ...
            Template(
                ...
                downloads=67,
                rating=4.7,
                description='Современный блог с красивым дизайном',
            ...
            Template(
                ...
                preview_url='/templates/landing.jpg'
            )
        ]
...
def home():
    return jsonify({
        ...
        'status': 'success',
        'version': '1.0.0',
        'api_url': 'https://prothemesru.vercel.app',
        'features': [
